...
extension BookingStatusX on BookingStatus {
  ...
  Color get color {
    switch (this) {
      case BookingStatus.upcoming:   return const Color(0xFF1A7FA8);
      case BookingStatus.ongoing:    return const Color(0xFF27AE60);
      case BookingStatus.confirmed:  return const Color(0xFF27AE60);
      case BookingStatus.completed:  return const Color(0xFF6B7A8D);
      case BookingStatus.cancelled:  return const Color(0xFFE74C3C);
      case BookingStatus.pending:    return const Color(0xFFF0A500);
      case BookingStatus.checkedIn:  return const Color(0xFF0B4F6C);
    }
  }
...
//  BookingServiceType
// ════════════════════════════════════════════════════════════
enum BookingServiceType { hotel, travelPackage, tourGuide, activity, flight, restaurant }
